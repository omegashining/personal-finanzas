...
/*
 * DatosAnteriores.java
 *
 * Created on 29/11/2009, 02:51:13 PM
 */
 ...
 * @author Gabriel
 */
public class DatosAnteriores extends javax.swing.JInternalFrame {

    /** Creates new form DatosAnteriores */
    ...
    public void setAnio( int index ) {
        anio.setSelectedIndex(index);
    }

    public String getAnio(){
        return anio.getSelectedItem().toString();
    }
    ...
    public void cargarDatos1 () {
        activoCirculante.setValueAt(62000, 0, 1);
        activoCirculante.setValueAt(106000, 1, 1);
        activoCirculante.setValueAt(31000, 2, 1);
        activoCirculante.setValueAt(74000, 3, 1);
        activoCirculante.setValueAt(30000, 4, 1);
        activoCirculante.setValueAt(74000, 5, 1);

        activoFijo.setValueAt(null, 0, 1);
        activoFijo.setValueAt(null, 1, 1);
        activoFijo.setValueAt(144000, 2, 1);
        activoFijo.setValueAt(100000, 3, 1);
        activoFijo.setValueAt(null, 4, 1);
        activoFijo.setValueAt(200000, 5, 1);

        activoDiferido.setValueAt(null, 0, 1);
        activoDiferido.setValueAt(58000, 1, 1);
        activoDiferido.setValueAt(98000, 2, 1);

        pasivoCirculante.setValueAt(49000, 0, 1);
        pasivoCirculante.setValueAt(85000, 1, 1);
        pasivoCirculante.setValueAt(82000, 2, 1);

        pasivoFijo.setValueAt(null, 0, 1);
        pasivoFijo.setValueAt(108000, 1, 1);

        capital.setValueAt(480000, 0, 1);

        otras.setValueAt(1231000, 0, 1);
        otras.setValueAt(125000, 1, 1);
        otras.setValueAt(933000, 2, 1);
        otras.setValueAt(null, 3, 1);
        otras.setValueAt(null, 4, 1);
    }

    public void cargarDatos2 () {
        activoCirculante.setValueAt(689000, 0, 1);
        activoCirculante.setValueAt(836000, 1, 1);
        activoCirculante.setValueAt(520000, 2, 1);
        activoCirculante.setValueAt(100000, 3, 1);
        activoCirculante.setValueAt(285000, 4, 1);
        activoCirculante.setValueAt(626000, 5, 1);

        activoFijo.setValueAt(800000, 0, 1);
        activoFijo.setValueAt(2500000, 1, 1);
        activoFijo.setValueAt(400000, 2, 1);
        activoFijo.setValueAt(150000, 3, 1);
        activoFijo.setValueAt(100000, 4, 1);
        activoFijo.setValueAt(215000, 5, 1);

        activoDiferido.setValueAt(null, 0, 1);
        activoDiferido.setValueAt(60000, 1, 1);
        activoDiferido.setValueAt(15000, 2, 1);

        pasivoCirculante.setValueAt(1200000, 0, 1);
        pasivoCirculante.setValueAt(300000, 1, 1);
        pasivoCirculante.setValueAt(700000, 2, 1);

        pasivoFijo.setValueAt(1000000, 0, 1);
        pasivoFijo.setValueAt(550000, 1, 1);

        capital.setValueAt(3200000, 0, 1);

        otras.setValueAt(3800000, 0, 1);
        otras.setValueAt(570000, 1, 1);
        otras.setValueAt(2884000, 2, 1);
        otras.setValueAt(null, 3, 1);
        otras.setValueAt(null, 4, 1);
    }
    ...
    private void initComponents() {
        ...
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(finanzas.FinanzasApp.class).getContext().getResourceMap(DatosAnteriores.class);
        ...
        labelAnio.setText(resourceMap.getString("labelAnio.text")); // NOI18N
        labelAnio.setName("labelAnio"); // NOI18N
        ...
        anio.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "2006", "2007", "2008", "2009", "2010", "2011", "2012", "2013", "2014" }));
